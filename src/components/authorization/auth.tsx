      ...
      <div className="m-auto border-2 border-orange-100 rounded-md space-y-5 p-5 w-[400px] h-fit shadow-lg ">
        ...
        <div className="justify-center flex items-center">
          <h1>
            ...
            <Button onClick={togglePage} className="font-bold text-orange-500">Create Account</Button>
          </h1>
        </div>
      </div>
    </div>
        ...
        <div>
          <h1>
            ...
            {/* <Link to="/">
              ...
              <Button onClick={togglePage} className="font-bold text-orange-500">SignIn</Button>
          </h1>
        </div>
      </div>
    </div>
