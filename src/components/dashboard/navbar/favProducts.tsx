...
const FavProducts = () => {
  ...
  return (
    ...
    {favoriteProduct && favoriteProduct.length > 0 && (
      <div className="w-[100%] h-screen  md:w-full md:h-full overflow-y-scroll justify-center items-center border-2 border-gray-200 bg-orange-100 p-10 rounded-lg shadow-lg">
